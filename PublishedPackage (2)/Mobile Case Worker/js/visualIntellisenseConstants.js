...
(function(Core) {"use strict";
    ...
    Core.Namespace.define("AppMagic.AuthoringTool.VisualIntellisense", {
        BooleanValues: [{
                ...
                text: falseKeyword, displayText: falseKeyword, image: "", description: falseKeyword, ruleValue: falseKeyword
                    ...
                    text: translateToLocaleSpecific("Shape!Square"), displayText: AppMagic.Strings.VisualIntellisenseShapesSquare, image: "../images/designrule_squareicon.svg", description: "", ruleValue: "square"
                }, {
                    text: translateToLocaleSpecific("Shape!Circle"), displayText: AppMagic.Strings.VisualIntellisenseShapesCircle, image: "../images/designrule_circleicon.svg", description: "", ruleValue: "circle"
                }], ShapesInvariant: [{
                    text: "Shape!Square", displayText: AppMagic.Strings.VisualIntellisenseShapesSquare, image: "../images/designrule_squareicon.svg", description: "", ruleValue: "square"
                }, {
                    text: "Shape!Circle", displayText: AppMagic.Strings.VisualIntellisenseShapesCircle, image: "../images/designrule_circleicon.svg", description: "", ruleValue: "circle"
                }], PenModes: [{
                    ...
                    text: translateToLocaleSpecific("PenSmoothing!Smooth"), displayText: AppMagic.Strings.VisualIntellisensePenModesSmooth, image: "../images/pen_smoothingicon.svg", description: "", ruleValue: "smooth"
                }, {
                    text: translateToLocaleSpecific("PenSmoothing!Rough"), displayText: AppMagic.Strings.VisualIntellisensePenModesRough, image: "../images/pen_roughicon.svg", description: "", ruleValue: "rough"
                }], PenSmoothingsInvariant: [{
                    text: "PenSmoothing!Smooth", displayText: AppMagic.Strings.VisualIntellisensePenModesSmooth, image: "../images/pen_smoothingicon.svg", description: "", ruleValue: "smooth"
                }, {
                    text: "PenSmoothing!Rough", displayText: AppMagic.Strings.VisualIntellisensePenModesRough, image: "../images/pen_roughicon.svg", description: "", ruleValue: "rough"
                }], PenTypes: [{
