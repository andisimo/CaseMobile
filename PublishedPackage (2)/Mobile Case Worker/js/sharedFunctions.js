...
(function(Core) {"use strict";
    Core.Namespace.define("AppMagic.Functions", {
        _resultColumnName: "Result", _defaultComboIterationLimit: 500, _millisecondsPerDay: 864e5, _millisecondsPerMinute: 6e4, _colorTable: {
                ...
                var alpha = color & 4278190080,
                    ...
                    green = (color & 65280) >> 8,
                    blue = color & 255,
                    interpolator = Math.abs(AppMagic.Utility.clamp(fadeDelta, -1, 1)),
