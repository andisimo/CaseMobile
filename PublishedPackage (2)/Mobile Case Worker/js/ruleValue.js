...
(function(Core) {"use strict";
    var ColorDivClass = "colorDiv",
        ...
        RuleValue = Core.Class.derive(AppMagic.Utility.Disposable, function RuleValue_ctor(template) {
            ...
            _template: null, _selectedIndex: null, notifyAfterHide: function() {
                    ...
                    if ((isKeyUpDown || evt.key !== AppMagic.AuthoringTool.Keys.down && evt.key !== AppMagic.AuthoringTool.Keys.up) && (!isKeyUpDown || evt.key !== AppMagic.AuthoringTool.Keys.right && evt.key !== AppMagic.AuthoringTool.Keys.left)) {
                        ...
                        if (isItemSelected || (currentItemIndex = -1), currentItemIndex >= 0 && (evt.key === AppMagic.AuthoringTool.Keys.tab || evt.key === AppMagic.AuthoringTool.Keys.enter)) {
                            this.normalizedValue = values[currentItemIndex].text;
                            return
                        }
                        (evt.key === AppMagic.AuthoringTool.Keys.down || evt.key === AppMagic.AuthoringTool.Keys.right) && currentItemIndex < values.length - 1 ? (currentItemIndex++, this._selectedIndex(currentItemIndex)) : (evt.key === AppMagic.AuthoringTool.Keys.up || evt.key === AppMagic.AuthoringTool.Keys.left) && (currentItemIndex > 0 ? currentItemIndex-- : currentItemIndex = 0, this._selectedIndex(currentItemIndex))
                    }
        ...
        EnumRuleValue = Core.Class.derive(RuleValue, function EnumRuleValue_ctor(template, rhs) {
        ...
        RangeRuleValue = Core.Class.derive(RuleValue, function RangeRuleValue_ctor(template, rhs, range) {
            RuleValue.call(this, template);
            this._ruleValue = rhs;
            this._range = range;
        ...
        FontFamilyMru = Core.Class.define(function FontFamilyMru_ctor() {
        ...
        FontFamilyRuleValue = Core.Class.derive(RuleValue, function FontRuleValue_ctor(mru, rhs) {
        ...
        PenTypeRuleValue = Core.Class.derive(RuleValue, function PenTypeRuleValue_ctor(template, rhs) {
            RuleValue.call(this, template);
            this._rhs = rhs;
        ...
        ColorMru = Core.Class.define(function ColorMru_ctor() {
        ...
        ColorRuleValue = Core.Class.derive(RangeRuleValue, function ColorRuleValue_ctor(mru, rhs) {
            ...
            _mru: null, _selectedColumn: null, _selectedRow: null, handleColorBlur: function(data, evt) {
                    ...
                    return activeElem && Core.Utilities.hasClass(activeElem, ColorDivClass) || (this._selectedRow(-1), this._selectedColumn(-1)), !0
                    ...
                    switch (evt.key) {
                        case AppMagic.AuthoringTool.Keys.down:
                            this._handleArrow(0, 1);
                            break;
                        case AppMagic.AuthoringTool.Keys.up:
                            this._handleArrow(0, -1);
                            break;
                        case AppMagic.AuthoringTool.Keys.left:
                            this._handleArrow(-1, 0);
                            break;
                        case AppMagic.AuthoringTool.Keys.right:
                            this._handleArrow(1, 0);
                            break;
                        case AppMagic.AuthoringTool.Keys.tab:
                        case AppMagic.AuthoringTool.Keys.enter:
                            this.normalizedValue = value.clone();
                            break
                    }
    ...
    Core.Namespace.define("AppMagic.RuleValues", {
