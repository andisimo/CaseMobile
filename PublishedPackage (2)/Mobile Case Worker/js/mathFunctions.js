        ...
        _sumCalculator: function(count, sum) {
            return count === 0 ? 0 : sum
                ...
                var successFn = function() {
                        return isError ? Core.Promise.as(null) : Core.Promise.as(calculatorFunc(count, sum))
                    },
                    errorFn = function() {
                        return Core.Promise.as(null)
                    };
                ...
                return source === null ? Core.Promise.as(null) : !(source instanceof Array) || source.length === 0 || typeof valueFunc != "function" ? Core.Promise.as(null) : AppMagic.Functions._sumAverage_TCoreAsync(source, AppMagic.Functions._averageCalculator, valueFunc)
            }, sum: function(arg) {
                ...
                return source === null ? Core.Promise.as(null) : !(source instanceof Array) || typeof valueFunc != "function" ? Core.Promise.as(null) : AppMagic.Functions._sumAverage_TCoreAsync(source, AppMagic.Functions._sumCalculator, valueFunc)
                ...
                var successFn = function(variance) {
                        return variance === null || typeof variance != "number" || !isFinite(variance) ? Core.Promise.as(null) : Core.Promise.as(Math.sqrt(variance))
                    },
                ...
                var successFn = function() {
                        if (isError)
                            return Core.Promise.as(null);
                        var variance = AppMagic.Functions._varianceCalculator(count, sum, sumOfSquares);
                        return Core.Promise.as(variance)
                    },
                    errorFn = function() {
                        return Core.Promise.as(null)
                    };
                ...
                return source === null ? Core.Promise.as(null) : !(source instanceof Array) || source.length === 0 || typeof valueFunc != "function" ? Core.Promise.as(null) : AppMagic.Functions._varianceCore_TAsync(source, valueFunc)
                ...
                var successFn = function() {
                        return isError ? Core.Promise.as(null) : typeof extremeValue == "undefined" ? Core.Promise.as(0) : Core.Promise.as(extremeValue)
                    },
                    errorFn = function() {
                        return Core.Promise.as(null)
                    };
                ...
                return source === null ? Core.Promise.as(null) : !(source instanceof Array) || source.length === 0 || typeof valueFunc != "function" ? Core.Promise.as(null) : AppMagic.Functions._minMax_TCoreAsync(source, !1, valueFunc)
            }, min: function(arg) {
                ...
                return source === null ? Core.Promise.as(null) : !(source instanceof Array) || source.length === 0 || typeof valueFunc != "function" ? Core.Promise.as(null) : AppMagic.Functions._minMax_TCoreAsync(source, !0, valueFunc)
