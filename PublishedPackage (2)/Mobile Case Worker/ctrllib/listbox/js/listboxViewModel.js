...
(function(Core) {"use strict";
    var util = AppMagic.Utility,
        MAX_ITEMS = 500,
        ListboxViewModel = Core.Class.define(function ListboxViewModel_ctor(controlContext) {
            ...
            _currentItemsArray: null, _controlContext: null, _properties: null, _behaviors: null, _id: null, _defaultChanged: null, modelProperties: {get: function() {
                    ...
                    parentViewModel.controlContext.viewState.disabled() || (parentViewModel.properties.Multiple() ? keyEvent.shiftKey ? parentViewModel._setSelectedItemsWithShift(listboxItemViewModel, parentViewModel) : parentViewModel._setSelectedItemsWithoutShift(listboxItemViewModel, parentViewModel) : parentViewModel._setSelectedItemsSingle(listboxItemViewModel, parentViewModel), parentViewModel._setSelectedItem(parentViewModel))
                    ...
                    if (lastSelectedItem)
                        switch (keyEvent.keyCode) {
                            ...
                            case AppMagic.Constants.KeyCodes.pageDown:
                                ...
                                break;
                            case AppMagic.Constants.KeyCodes.pageUp:
                    ...
                    for (var i = 0; i < defaultItemsArray.length; i++) {
                        ...
                        if (item._ID = i + 1, item.Value || (item.Value = null), item._ID > MAX_ITEMS) {
    ...
    Core.Namespace.define("AppMagic.Controls", {ListboxViewModel: ListboxViewModel})
})(WinJS);