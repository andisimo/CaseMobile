                    ...
                    return Object.defineProperty(GalleryRenderer.prototype, "pageOffset", {
                            ...
                            len > 0 ? this._initiateAsynchronousRendering(windowIndices) : this._updateWindow(windowIndices, 0)
                                ...
                                var startingMin = 0,
                                    startingMax = -1;
                                if (len > 0) {
                                    for (var startingIds = {}, contiguousRegionStarted = !1, i = windowIndices.min; i <= windowIndices.max; i++) {
                                        ...
                                        if (contiguousRegionStarted)
                                            if (realized)
                                                startingMax = i;
                                            else
                                                break;
                                        else
                                            realized && (contiguousRegionStarted = !0, startingMin = startingMax = i)
                                    }
                                    this._unrealizeAllExcept(startingIds);
                                    startingMax - startingMin < 0 && (startingMin = windowIndices.min, startingMax = startingMin - 1);
                                    this._updateWindow(windowIndices, startingMin);
                                    this._asyncRenderingManager.reset(startingMin, startingMax);
                                ...
                                this._asyncRenderingManager.renderAsync(windowIndices.min, windowIndices.max, this._realize.bind(this, !0), this._realize.bind(this, !1), this._unrealize.bind(this), this._updateWindow.bind(this, windowIndices))
                            }, GalleryRenderer.prototype._realize = function(beforeWindow, realizeIndex) {
                                if (!this._controlContext.isTemplate || realizeIndex !== 0) {
                                    ...
                                    var itemContainer;
                                    rowBindingContext.realized ? itemContainer = rowBindingContext.container : (this.instantiateItemContainerTemplate(this._surrogateElement), itemContainer = this._surrogateElement.firstElementChild);
                                    beforeWindow && this._iteratedWindow.firstElementChild ? this._iteratedWindow.insertBefore(itemContainer, this._iteratedWindow.firstElementChild) : this._iteratedWindow.appendChild(itemContainer);
            ...
            var Template = function() {
                    ...
                    return Template.prototype.initControlContext = function(controlContext) {
                            ...
                            controlContext._parentReplicatedContext = null
                                ...
                                controlContext._clickListener = function(evt) {
                                ...
                                container.removeEventListener("click", controlContext._clickListener);
                                delete controlContext._clickListener
            ...
            var GalleryViewModel = function() {
                    ...
                    return Object.defineProperty(GalleryViewModel.prototype, "rootElement", {
                            ...
                            get: function() {
                                ...
                                this._controlContext.modelProperties.VisibleIndex.setValue(AppMagic.Utility.clamp(oneBasedIndex, 1, this._itemsLength()));
                                this._scrollToVisibleIndex()
                                ...
                                this._layoutSubscription = null;
                                this._controlContext.isTemplate && this._galleryControl.OpenAjax.controlManager.removeNestedCanvas(this._galleryControl.OpenAjax.getId(), 0)
                                ...
                                var viewProps = this._controlContext.properties,
                                    ...
                                    controlContext = this._controlContext;
                                ...
                                var verticalLayout = this.layout() === "vertical",
                                    ...
                                    calculatedIndex = Math.floor(this._templateSize() === 0 ? 0 : offset / this._templateSize()) + 1;
                                ...
                                authoringAreaBindingContext.container = _templateContainer;
                                this._template.parentElement.removeChild(this._template);
                                _templateContainer.appendChild(this._template)
