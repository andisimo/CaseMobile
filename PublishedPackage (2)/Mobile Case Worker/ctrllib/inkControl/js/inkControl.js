...
(function(Core, Platform) {"use strict";
    var util = AppMagic.Utility,
        CommandBarButtonsCount = 5,
        CommandBarButtonWidth = 50,
        InkControl = Core.Class.define(function InkControl_ctor(){}, {
            _colorMru: new AppMagic.RuleValues.ColorMru, DrawingMode: "draw", EraserMode: "erase", SelectionMode: "select", ShapeCircle: "circle", ShapeSquare: "square", ContextRound: "round", ContextSquare: "square", PenSmooth: "smooth", PenRough: "rough", StrokesOutput: "Strokes", ImageOutput: "Image", initControlContext: function(controlContext) {
                    ...
                    util.createOrSetPrivate(controlContext, "thicknessValue", ko.observable(2));
                    ...
                    util.createOrSetPrivate(controlContext, "_commandBarButtons", ko.observableArray([{
                            ...
                            propertyName: "Smoothing", image: "../images/pen_smoothingicon.svg", visible: ko.observable(!0)
                        }, {
                            propertyName: "Mode", image: "../images/pen_selectionicon.svg", visible: ko.observable(!0)
                        }, {
                            propertyName: "Shape", image: "../images/penshapeicon.svg", visible: ko.observable(!0)
                        }, {
                            propertyName: "Color", image: "../images/pencoloricon.svg", visible: ko.observable(!0)
                        }, {
                    ...
                    util.createOrSetPrivate(controlContext, "_smoothing", "smooth");
                    ...
                    util.createOrSetPrivate(controlContext, "canvasWidth", null);
                    util.createOrSetPrivate(controlContext, "canvasHeight", null);
                    ...
                    controlContext.properties.Strokes() !== null && controlContext.properties.Strokes().Url !== "" && this._loadFromObjectURL(controlContext.properties.Strokes().Url, controlContext).then(function() {
                    ...
                    controlContext._shapeSubscription = controlContext.properties.Shape.subscribe(this.onChangeShapeWithView.bind(this, controlContext));
                    ...
                    controlContext._smoothingSubscription = controlContext.properties.Smoothing.subscribe(this.onChangeSmoothingWithView.bind(this, controlContext));
                    ...
                    this.onChangeShapeWithView(controlContext);
                    this.onChangeSizeWithView(controlContext);
                    this.onChangeSmoothingWithView(controlContext);
                    this.onChangeClearWithView(controlContext);
                    this.onChangeDefaultStrokesWithView(controlContext);
                    controlContext.canvasWidth = ko.computed(function() {
                        return controlContext.properties.Width() - this._getBorderThickness(controlContext) * 2
                    }.bind(this));
                    controlContext.canvasHeight = ko.computed(function() {
                        return controlContext.properties.Height() - this._getBorderThickness(controlContext) * 2
                    }.bind(this));
                    ...
                    controlContext._smoothingSubscription.dispose();
                    controlContext._smoothingSubscription = null;
                    controlContext._shapeSubscription.dispose();
                    controlContext._shapeSubscription = null;
                    controlContext._defaultStrokesSubscription.dispose();
                    controlContext._defaultStrokesSubscription = null;
                    controlContext.canvasWidth.dispose();
                    controlContext.canvasWidth = null;
                    controlContext.canvasHeight.dispose();
                    controlContext.canvasHeight = null
                    ...
                    this._setContextInfoFromMode(controlContext)
                }, onChangeShapeWithView: function(controlContext) {
                    var shapeNewValue = controlContext.properties.Shape();
                    shapeNewValue !== null && this._updateDrawingAttribute("penTip", this._penShapeValuetoDrawingAttributes(shapeNewValue), controlContext)
                ...
                }, onChangeSmoothingWithView: function(controlContext) {
                    var smoothingNewValue = controlContext.properties.Smoothing();
                    smoothingNewValue !== null && (controlContext._smoothing = smoothingNewValue.toLowerCase(), this._renderAllStrokes(controlContext))
                    ...
                    var widthNewValue = controlContext.modelProperties.Width.getValue();
                    if (widthNewValue) {
                    ...
                    controlContext._context.lineCap = this._penShapeValuetoContextLineShape(controlContext.properties.Shape());
                    ...
                    controlContext._inkManager.getStrokes().forEach(function(stroke) {
                        ...
                        var color = this._toColorString(att.color),
                            strokeSize = att.size,
                            lineShape = this._drawingAttributestoContextLineShape(att.penTip);
                        if (stroke.selected) {
                    ...
                    try {
                        ...
                        var smoothing = controlContext._smoothing,
                            first = !0;
                        var renderingSegments = stroke.getRenderingSegments();
                        if (renderingSegments.forEach(function(segment) {
                            first ? (controlContext._context.moveTo(segment.position.x, segment.position.y), first = !1) : smoothing === this.PenSmooth ? controlContext._context.bezierCurveTo(segment.bezierControlPoint1.x, segment.bezierControlPoint1.y, segment.bezierControlPoint2.x, segment.bezierControlPoint2.y, segment.position.x, segment.position.y) : controlContext._context.lineTo(segment.position.x, segment.position.y)
                        }.bind(this)), renderingSegments.size === 2 && renderingSegments[0].x === renderingSegments[1].x && renderingSegments[0].y === renderingSegments[1].y)
                            if (lineShape === this.ShapeSquare) {
                                var halfWidth = width / 2;
                                controlContext._context.fillRect(renderingSegments[0].position.x - halfWidth, renderingSegments[0].position.y - halfWidth, width, width)
                            }
                            else
                                controlContext._context.beginPath(),
                                controlContext._context.arc(renderingSegments[0].position.x, renderingSegments[0].position.y, 1, 0, 2 * Math.PI, !0),
                                controlContext._context.fill();
                        controlContext._context.stroke();
                        controlContext._context.closePath()
                    }
                    finally {
                    ...
                    controlContext._inkManager.getStrokes().length > 0 ? controlContext._recognizing ? (controlContext._pendingRecognition = !0, setImmediate(this._recognize.bind(this, controlContext))) : (controlContext._recognizing = !0, controlContext._inkManager.recognizeAsync(this._anySelected(controlContext) ? Platform.UI.Input.Inking.InkRecognitionTarget.selected : Platform.UI.Input.Inking.InkRecognitionTarget.all).done(function(results) {
                        ...
                        controlContext._isLoaded && (controlContext._recognizing = !1, controlContext._pendingRecognition || setImmediate(this._recognize.bind(this, controlContext)))
                    ...
                    if (controlContext._inkManager.getStrokes().length > 0) {
                        ...
                        return controlContext._inkManager.saveAsync(inMemoryRandomAccessStream).then(function() {
                                ...
                                url && (AppMagic.Utility.blobManager.addRef(url), controlContext.modelProperties.Strokes.setValue({Url: url}), this._attachBlobUrl(this.StrokesOutput, url, controlContext));
                        ...
                        return controlContext.modelProperties.Strokes.setValue({Url: ""}), this._attachBlobUrl(this.StrokesOutput, "", controlContext), Core.Promise.wrap(!0)
                }, _saveCanvasToObjectURL: function(controlContext) {
                    var canvas = controlContext._canvas;
                    return canvas.width <= 0 || canvas.height <= 0 ? Core.Promise.wrap(!0) : controlContext._inkManager.getStrokes().length > 0 ? this._getImageUriFromCanvasAsync(controlContext._context).then(function(url) {
                            url && (controlContext.modelProperties.Image.setValue({Url: url}), this._attachBlobUrl(this.ImageOutput, url, controlContext))
                        }.bind(this), function(err) {
                            this._attachBlobUrl(this.ImageOutput, "", controlContext)
                        }.bind(this)) : (controlContext.modelProperties.Image.setValue({Url: ""}), this._attachBlobUrl(this.ImageOutput, "", controlContext), Core.Promise.wrap(!0))
                    ...
                    return inMemoryRandomAccessStream.size = 0, Platform.Graphics.Imaging.BitmapEncoder.createAsync(Platform.Graphics.Imaging.BitmapEncoder.pngEncoderId, inMemoryRandomAccessStream).then(function(encoder) {
                            ...
                            return encoder.setPixelData(Platform.Graphics.Imaging.BitmapPixelFormat.rgba8, Platform.Graphics.Imaging.BitmapAlphaMode.straight, width, height, 96, 96, outputPixelData.data), encoder.flushAsync().then(function() {
                                    ...
                                    return AppMagic.Utility.blobManager.addRef(url), inMemoryRandomAccessStream.close(), Core.Promise.wrap(url)
                                })
                        }.bind(this), function(err) {
                            inMemoryRandomAccessStream.close()
                        })
                    ...
                    this._renderAllStrokes(controlContext);
                    var promises = [];
                    return promises.push(this._saveStrokesToObjectURL(controlContext)), promises.push(this._saveCanvasToObjectURL(controlContext)), controlContext._pendingRecognition || this._recognize(controlContext), Core.Promise.join(promises)
                }, _penShapeValuetoContextLineShape: function(penShapeValue) {
                    return penShapeValue === this.ShapeSquare ? this.ContextSquare : this.ContextRound
                }, _penShapeValuetoDrawingAttributes: function(penShapeValue) {
                    return penShapeValue === this.ShapeSquare ? Platform.UI.Input.Inking.PenTipShape.rectangle : Platform.UI.Input.Inking.PenTipShape.circle
                }, _drawingAttributestoContextLineShape: function(penTipValue) {
                    return penTipValue === Platform.UI.Input.Inking.PenTipShape.rectangle ? this.ContextSquare : this.ContextRound
                    ...
                    for (var anchor = evt.target; anchor && !Core.Utilities.hasClass(anchor, "button"); )
                    ...
                    if (evt.target.parentElement !== null && !controlContext._flyoutHidden()) {
                        var isFlyoutElement = Core.Utilities.hasClass(evt.target.parentElement, "appmagic-inkControl-flyoutMenuItem") || Core.Utilities.hasClass(evt.target.parentElement, "appmagic-inkControl-flyoutContent") || controlContext._flyoutElement.contains(evt.target);
                    ...
                    if (currentProperty) {
                        ...
                        switch (currentProperty) {
                            case"Shape":
                                var penShapeExpression = ko.computed({
                                        read: function() {
                                            switch (property()) {
                                                case"circle":
                                                    return "Shape!Circle";
                                            ...
                                            return "Shape!Circle"
                                        }, write: function(expressionValue) {
                                ...
                                value = new AppMagic.RuleValues.EnumRuleValue("shape", penShapeExpression);
                                valueTemplate = "shapeInvariant";
                                break;
                            case"Color":
                                ...
                                break;
                            case"Mode":
                                var penModeExpression = ko.computed({
                                        read: function() {
                                            switch (property()) {
                                                case"draw":
                                                    return "PenMode!Draw";
                                                case"erase":
                                                    return "PenMode!Erase";
                                                case"select":
                                                    return "PenMode!Select"
                                            }
                                            return "PenMode!Draw"
                                        }, write: function(expressionValue) {
                                                switch (expressionValue) {
                                ...
                                value = new AppMagic.RuleValues.EnumRuleValue("penMode", penModeExpression);
                                valueTemplate = "penModeInvariant";
                                break;
                            case"Smoothing":
                                var penSmoothingExpression = ko.computed({
                                        read: function() {
                                            switch (property()) {
                                                case"smooth":
                                                    return "PenSmoothing!Smooth";
                                                case"rough":
                                                    return "PenSmoothing!Rough"
                                            }
                                            return "PenSmoothing!Smooth"
                                        }, write: function(expressionValue) {
                                                switch (expressionValue) {
                                                    case"PenSmoothing!Smooth":
                                                        property("smooth");
                                                        break;
                                                    case"PenSmoothing!Rough":
                                                        property("rough");
                                                        break;
                                                    default:
                                                        break
                                ...
                                value = new AppMagic.RuleValues.EnumRuleValue("penSmoothing", penSmoothingExpression);
                                valueTemplate = "penSmoothingInvariant";
                                break;
                            case"Size":
                                var penThicknessValue = ko.computed({
                                        read: function() {
                                            var thicknessPropertyValue = property();
                                            if (controlContext.thicknessValue(thicknessPropertyValue || 0), thicknessPropertyValue === null)
                                                return "0";
                                            ...
                                            return stringThicknessValue
                                                ...
                                                controlContext.thicknessValue(integerValue || 0)
                                            }, owner: this
                                    });
                ...
                }, _getBorderThickness: function(controlContext) {
                    var borderStyle = controlContext.properties.BorderStyle();
                    return !borderStyle || borderStyle === "none" ? 0 : AppMagic.Controls.converters.pxConverter.model(controlContext.properties.BorderThickness())
                }, _getContentContainer: function(element) {
                    while (element && !element.classList.contains("contentContainer") && !element.classList.contains("canvasContentDiv"))
                        element = element.parentElement;
                    return element
                }
        }, {});
    Core.Namespace.define("AppMagic.Controls", {InkControl: InkControl})
})(WinJS, Windows);