...
(function(Core, Platform) {"use strict";
    var AudioPlayback = Core.Class.derive(AppMagic.Controls.Playback, function AudioPlayback_ctor() {
    ...
    Core.Namespace.define("AppMagic.Controls", {AudioPlayback: AudioPlayback})
})(WinJS, Windows);