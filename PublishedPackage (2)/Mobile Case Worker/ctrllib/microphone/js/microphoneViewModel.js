...
(function(Core, Platform) {"use strict";
    var util = AppMagic.Utility,
        ...
        MicrophoneViewModel = Core.Class.define(function MicrophoneViewModel_ctor(controlContext) {
    ...
    Core.Namespace.define("AppMagic.Controls", {MicrophoneViewModel: MicrophoneViewModel})
})(WinJS, Windows);