...
(function(Core) {"use strict";
    var util = AppMagic.Utility,
        ...
        HtmlMedia = Core.Class.derive(AppMagic.Controls.Media, function HtmlMedia_ctor() {
            ...
            _container: null, _mediaElement: null, _audioElementEnabled: null, _overlayVisible: null, _loop: null, _showControls: null, _wasVolumeButtonRecentlyClicked: null, _wasMouseRecentlyMoved: null, _seekBar: null, _seekBarValue: null, _seekBarTime: null, _isMuted: null, _volume: null, _isScrubbing: !1, _hideControlsTimeout: AppMagic.Constants.Controls.controlsFadeDelay, _hideControlsTimeoutHandle: null, _hideVolumeTimeout: AppMagic.Constants.Controls.volumeSliderHideDelay, _hideVolumeTimeoutHandle: null, onClick: function() {
                ...
                }, onPlaybackSeekBarMouseDown: function() {
                    return this._isScrubbing = !0, !0
                }, onPlaybackSeekBarMouseUp: function() {
                    this._isScrubbing = !1;
                    this._updateTime(this._seekBarValue())
                    ...
                    return AppMagic.Utility.mediaUrlHelper(oldValue, newValue).then(function(src) {
                        ...
                        }.bind(this), function(){}), this._seekBarDuration(this._getTimeFormattedString(0)), this._seekBarTime(this._getTimeFormattedString(0)), this._seekBarValue(this.seekBarMin), startTime !== 0 && (this.currentTime = startTime), Core.Promise.wrap(!0)
                }, play: function() {
        ...
        NullMediaElement = Core.Class.define(function NullMediaElement_ctor(){}, {
        ...
        AudioHtmlMedia = Core.Class.derive(HtmlMedia, function AudioHtmlMedia_ctor() {
            HtmlMedia.call(this)
        }, {template: {get: function() {
                    return "audio"
                }}}),
        VideoHtmlMedia = Core.Class.derive(HtmlMedia, function VideoHtmlMedia_ctor() {
            HtmlMedia.call(this)
        }, {template: {get: function() {
                    return "video"
                }}});
    Core.Namespace.define("AppMagic.Controls", {
